...
function! mycyberpunk#set_highlight(group, style)
...
call s:h("Comment", { "fg": s:blue, "gui": "italic", "cterm": "italic" }) " any comment
call s:h("Constant", { "fg": s:cyan }) " any constant
call s:h("String", { "fg": s:green }) " a string constant: "this is a string"
call s:h("Character", { "fg": s:red }) " a character constant: 'c', '\n'
...
call s:h("LineNr", { "fg": s:purple }) " Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
...
call s:h("Visual", { "fg": s:visual_black, "bg": s:comment_grey }) " Visual mode selection
